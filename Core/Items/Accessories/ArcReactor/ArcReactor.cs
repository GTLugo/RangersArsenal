...
namespace RangersArsenal.Core.Items.Accessories.ArcReactor
{
    ...
    public class ArcReactor : ModItem
    {
        ...
        public override void SetDefaults()
        {
            item.width  = 28;
            item.height = 28;
            item.value  = Item.sellPrice(0, 12, 25);
            item.rare   = 9;
            //item.expert = true;
            item.accessory = true;
        }
        ...
        {
            scale *= 0.5f;
            var texture = mod.GetTexture("Items/Accessories/ArcReactor/ArcReactor");
            spriteBatch.Draw(
                texture,
                new Vector2(
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetModPlayer<RAPlayer>().hasMSeed =  true;
            player.GetModPlayer<RAPlayer>().hasAmp   =  true;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddRecipeGroup("RangersArsenal:EvilAccessory");
