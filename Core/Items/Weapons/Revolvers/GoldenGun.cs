...
namespace RangersArsenal.Core.Items.Weapons.Revolvers //Such namescape
{
    public class GoldenGun : ModItem
    {
        ...
        {
            if (type == ProjectileID.Bullet) type = mod.ProjectileType("FireBullet");
        ...
        {
            scale *= 2f / 3f;
            var baseTexture = mod.GetTexture("Core/Items/Weapons/Revolvers/GoldenGun");
            var glowTexture = mod.GetTexture("Core/Items/Weapons/Revolvers/GoldenGun_Glow");
            spriteBatch.Draw(
                baseTexture,
                new Vector2(
