...
namespace RangersArsenal.Core.Items.Potions
{
    public class GunslingerPotion : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.buffTime =
                14400; //The amount of time the buff declared in item.buffType will last in ticks. 5400 / 60 is 90, so this buff will last 90 seconds.
        }
